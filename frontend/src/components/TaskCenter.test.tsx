...
const api = vi.hoisted(() => ({
  ...
  fetchChangeJobs: vi.fn(), acceptChangeJob: vi.fn(), rejectChangeJob: vi.fn(),
  retryChangeJob: vi.fn(), deleteChangeJob: vi.fn(), runWikiLint: vi.fn(),
}));
...
describe('TaskCenter', () => {
  it('restores persisted ingest and research tasks and filters status', async () => {
    ...
    api.fetchChangeJobs.mockResolvedValue([]);
    render(<TaskCenter />);
